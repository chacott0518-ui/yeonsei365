export const CATEGORIES = {
  ...
  {
    slug: 'q-1778494942642',
    category: 'womens' as CategoryKey,
    title: '어머니가 55세 넘어서 폐경이 온다고 하는 것 같은데 어떻게 해드려야 할',
    description: '전문의 답변을 준비 중입니다. 연세365산부인과(02-585-3650)로 문의하시면 더 빠른 답변을 받으실 수 있습니다.. 사당역 연세365산부인과 02-585-3650.',
    keywords: ["어머니가","사당역산부인과"],
    lastModified: '2026-05-11',
    
    
    faq: [{"q":"어머니가 55세 넘어서 폐경이 온다고 하는 것 같은데 어떻게 해드려야 할까요?","a":"전문의 답변을 준비 중입니다. 연세365산부인과(02-585-3650)로 문의하시면 더 빠른 답변을 받으실 수 있습니다."}],
    sections: [{"type": "text" as const,"title":"어머니가 55세 넘어서 폐경이 온다고 하는 것 같은데 어떻게 해드려야 할","content":"전문의 답변을 준비 중입니다. 연세365산부인과(02-585-3650)로 문의하시면 더 빠른 답변을 받으실 수 있습니다."}],
  },
  ]
