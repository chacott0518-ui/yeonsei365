...
const articleSchema = { '@context':'https://schema.org','@type':'Article', headline:'임신중절수술 금액·비용 | 낙태비용 가격 안내 | 연세365산부인과', datePublished:PAGE_DATE, dateModified:PAGE_MODIFIED, image:'https://www.yeonsei365.com/og-image.jpg', author:{'@type':'Organization',name:'연세365산부인과',url:'https://www.yeonsei365.com'}, publisher:{'@type':'MedicalOrganization',name:'연세365산부인과',logo:{'@type':'ImageObject',url:'https://i.imgur.com/f7h5DY0.png'}}, mainEntityOfPage:{'@type':'WebPage','@id':PAGE_URL}, url:PAGE_URL }
...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: '사당역 연세365산부인과 | 임신중절수술 전문', description: '임신중절수술 비용·방법·후기 전문의 직접 안내. 당일 수술 가능. 사당역 4번출구 02-585-3650.' },
