...
export const metadata: Metadata = {
  title: '찾아오시는길 | 연세365산부인과',
  description: '연세365산부인과 오시는 길. 서울 관악구 과천대로 939 3층, 사당역 4번출구 도보 3분. 2호선·4호선 환승. 02-585-3650.',
  alternates: { canonical: 'https://www.yeonsei365.com/about/location' },
  openGraph: { title: '찾아오시는길 | 연세365산부인과', url: 'https://www.yeonsei365.com/about/location', images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630 }] },
}

const faqSchema = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: '연세365산부인과 위치가 어디인가요?', acceptedAnswer: { '@type': 'Answer', text: '서울 관악구 과천대로 939 3층에 위치합니다. 지하철 사당역 4번출구 도보 3분 거리이며 2호선·4호선 환승역으로 접근이 편리합니다. 전화 02-585-3650으로 문의하세요.' } },
    { '@type': 'Question', name: '사당역에서 연세365산부인과까지 어떻게 가나요?', acceptedAnswer: { '@type': 'Answer', text: '지하철 4호선·2호선 사당역 4번출구로 나와서 도보 3분이면 도착합니다. 버스 이용 시 사당역 정류장에서 하차 후 도보로 이동하시면 됩니다.' } },
  ],
}
    ...
    <>
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: 'clamp(80px,12vw,110px) clamp(16px,5vw,24px) 80px', fontFamily: 'Pretendard, sans-serif', color: '#1A0A10', lineHeight: 1.8 }}>
        ...
        <h1 style={{ fontSize: 'clamp(24px,5vw,32px)', fontWeight: 900, lineHeight: 1.3, marginBottom: '8px' }}>
          찾아오시는길<br />
          <span style={{ color: '#E8305A' }}>사당역 4번출구 도보 3분</span>
        </h1>
        <p style={{ fontSize: '13px', color: '#999', marginBottom: '28px' }}>서울 관악구 과천대로 939 3층</p>
        ...
        <div style={{ background: 'linear-gradient(135deg, #FF8FAB 0%, #E8305A 100%)', borderRadius: '16px', padding: 'clamp(16px,4vw,24px)', marginBottom: '32px', color: '#fff' }}>
          <p style={{ fontWeight: 900, fontSize: '18px', marginBottom: '16px' }}>📍 연세365산부인과 위치 정보</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            {[
              { label: '주소', value: '서울 관악구 과천대로 939 3층' },
              { label: '지하철', value: '4호선·2호선 사당역 4번출구 도보 3분' },
        ...
        <div style={{ marginBottom: '32px', borderRadius: '16px', overflow: 'hidden', border: '1px solid #FFE0E8' }}>
          <img src="https://i.imgur.com/E5YzhoJ.png" alt="연세365산부인과 지도 사당역 4번출구 도보 3분" style={{ width: '100%', display: 'block' }} />
        </div>
        ...
        <div style={{ marginBottom: '32px' }}>
          {[
            { icon: '🚇', title: '지하철', desc: '4호선·2호선 사당역 4번출구 도보 3분. 강남, 서초, 방배, 이수, 관악, 동작, 과천 등 어디서든 접근이 편리한 환승역입니다.' },
        ...
        <div style={{ marginBottom: '32px' }}>
          {[
            { q: '연세365산부인과 위치가 어디인가요?', a: '서울 관악구 과천대로 939 3층에 위치합니다. 사당역 4번출구 도보 3분 거리이며 2호선·4호선 환승역으로 접근이 편리합니다.' },
            { q: '사당역에서 어떻게 가나요?', a: '4호선·2호선 사당역 4번출구로 나와서 도보 3분이면 도착합니다. 버스 이용 시 사당역 정류장 하차 후 도보로 이동하시면 됩니다.' },
          ].map((item, i) => (
        ...
        <div style={{ background: 'linear-gradient(135deg, #FF8FAB 0%, #E8305A 100%)', borderRadius: '20px', padding: 'clamp(20px,5vw,32px)', textAlign: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '14px', marginBottom: '22px' }}>사당역 4번출구 도보 3분 · 당일 예약 가능 · 비밀보장</p>
