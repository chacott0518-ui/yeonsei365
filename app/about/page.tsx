...
export const metadata: Metadata = {
  title: '병원소개 · 의료진 | 연세365산부인과',
  description: '사당역 연세365산부인과 병원 소개와 의료진 안내. 연세대 산부인과 전문의 이진우 원장이 직접 진료합니다. 사당역 4번출구 도보 3분. 02-585-3650.',
  keywords: ['연세365산부인과', '사당역산부인과', '이진우원장', '산부인과전문의', '사당역병원소개'],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: '병원소개 · 의료진 | 연세365산부인과',
    description: '사당역 연세365산부인과 병원 소개와 의료진 안내.',
    url: PAGE_URL,
    images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630 }],
    locale: 'ko_KR', type: 'article',
  },
  twitter: { card: 'summary_large_image', title: '병원소개 · 의료진 | 연세365산부인과', description: '사당역 연세365산부인과 병원 소개와 의료진 안내.' },
}
...
const medicalWebPageSchema = { '@context': 'https://schema.org', '@type': 'MedicalWebPage', name: '연세365산부인과 병원소개 의료진', url: PAGE_URL, specialty: { '@type': 'MedicalSpecialty', name: '산부인과' }, medicalAudience: { '@type': 'MedicalAudience', audienceType: '여성 환자' }, lastReviewed: PAGE_DATE, reviewedBy: { '@type': 'MedicalOrganization', name: '연세365산부인과', url: 'https://www.yeonsei365.com' }, about: { '@type': 'MedicalCondition', name: '산부인과 진료' } }
const howToSchema = { '@context': 'https://schema.org', '@type': 'HowTo', name: '연세365산부인과 예약 방법', description: '사당역 연세365산부인과 예약 단계별 안내', step: [ { '@type': 'HowToStep', position: 1, name: '전화 또는 카카오톡 예약', text: '02-585-3650으로 전화하거나 카카오톡으로 예약합니다.' }, { '@type': 'HowToStep', position: 2, name: '내원', text: '사당역 4번출구 도보 3분. 신분증 지참.' }, { '@type': 'HowToStep', position: 3, name: '진료', text: '산부인과 전문의가 직접 진료합니다.' } ], tool: { '@type': 'HowToTool', name: '연세365산부인과' } }
const speakableSchema = { '@context': 'https://schema.org', '@type': 'WebPage', name: '연세365산부인과 병원소개 의료진', url: PAGE_URL, speakable: { '@type': 'SpeakableSpecification', cssSelector: ['h1', 'h2', '.speakable-summary'] } }
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: 'clamp(80px,12vw,110px) clamp(16px,5vw,24px) 80px', fontFamily: 'Pretendard, sans-serif', color: '#1A0A10', lineHeight: 1.8 }}>
        ...
        <p style={{ fontSize: '13px', color: '#999', marginBottom: '28px' }}>사당역 4번출구 · 산부인과 전문의 직접 진료</p>
        ...
        <p style={{ fontSize: 'clamp(14px,3vw,16px)', marginBottom: '14px', wordBreak: 'keep-all' }}>
          연세365산부인과의원은 서울 관악구 사당역 4번출구 도보 3분 거리에 위치한 여성 전문 의원입니다. 연세대학교 의과대학을 졸업하고 신촌세브란스병원에서 산부인과 전문의 과정을 수료한 이진우 대표원장이 모든 진료를 직접 담당합니다.
        </p>
        ...
        <div style={{ background: 'linear-gradient(135deg, #FF8FAB 0%, #E8305A 100%)', borderRadius: '16px', padding: 'clamp(16px,4vw,24px)', marginBottom: '44px', color: '#fff' }}>
          <p style={{ fontWeight: 900, fontSize: 'clamp(15px,3.5vw,18px)', marginBottom: '16px' }}>📍 연세365산부인과 핵심 정보</p>
        ...
        <div style={{ marginBottom: '44px' }}>
          {[
            ...
            { icon: '🏥', title: '연중무휴 365일 운영', desc: '평일·토요일·일요일·공휴일 모두 운영합니다. 일요일에도 수술이 가능하며 사당역 4번출구 도보 3분으로 접근이 편리합니다.' },
          ].map(({ icon, title, desc }) => (
        ...
        <div style={{ background: 'linear-gradient(135deg, #FF8FAB 0%, #E8305A 100%)', borderRadius: '20px', padding: 'clamp(20px,5vw,32px)', textAlign: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '14px', marginBottom: '22px' }}>사당역 4번출구 도보 3분 · 1:1 비밀보장 · 연중무휴</p>
