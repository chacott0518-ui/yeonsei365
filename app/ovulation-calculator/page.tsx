...
export const metadata: Metadata = {
  ...
  twitter: { card: 'summary_large_image', title: '배란일 계산기 | 연세365산부인과', description: '생리 시작일·주기 입력으로 배란일·가임기·임신 최적일 즉시 확인.' },
};

const PAGE_URL = 'https://www.yeonsei365.com/ovulation-calculator'
const PAGE_DATE = '2026-04-01'
const PAGE_MODIFIED = '2026-05-22'
const articleSchema = { '@context':'https://schema.org','@type':'Article', headline:'배란일 계산기 | 가임기·배란일 자동 계산 연세365산부인과', datePublished:PAGE_DATE, dateModified:PAGE_MODIFIED, image:'https://www.yeonsei365.com/og-image.jpg', author:{'@type':'Organization',name:'연세365산부인과',url:'https://www.yeonsei365.com'}, publisher:{'@type':'MedicalOrganization',name:'연세365산부인과',logo:{'@type':'ImageObject',url:'https://i.imgur.com/f7h5DY0.png'}}, mainEntityOfPage:{'@type':'WebPage','@id':PAGE_URL}, url:PAGE_URL }
...
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'배란일 계산기 | 가임기·배란일 자동 계산', url:'https://www.yeonsei365.com/ovulation-calculator', specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, lastReviewed:'2026-05-22', reviewedBy:{'@type':'MedicalOrganization',name:'연세365산부인과',url:'https://www.yeonsei365.com'}, about:{'@type':'MedicalCondition',name:'배란일 계산'} }
const howToSchema = { '@context':'https://schema.org','@type':'HowTo', name:'배란일 계산하는 방법', description:'생리 시작일과 주기로 배란일·가임기 계산', step:[ {'@type':'HowToStep',position:1,name:'생리 시작일 입력',text:'마지막 생리 시작일을 입력합니다.'}, {'@type':'HowToStep',position:2,name:'생리주기 입력',text:'본인의 평균 생리주기(일수)를 입력합니다.'}, {'@type':'HowToStep',position:3,name:'배란일 확인',text:'배란일·가임기가 자동 계산됩니다. 정확한 확인은 연세365산부인과(02-585-3650)에서 초음파로 하세요.'} ], tool:{'@type':'HowToTool',name:'연세365산부인과'} }
