...
export const metadata: Metadata = {
  title: '배란일 계산기 | 가임기·배란일 자동 계산 — 연세365산부인과의원',
  description: '생리 시작일과 주기를 입력하면 배란일, 가임기 구간, 임신 최적일, 다음 생리 예정일을 달력으로 자동 계산합니다. 연세365산부인과의원 무료 배란일 계산기.',
  keywords: ['배란일계산기','배란일 계산','가임기 계산기','임신 가능한 날','생리주기 계산'],
  alternates: { canonical: 'https://www.yeonsei365.com/ovulation-calculator' },
  openGraph: {
    title: '배란일·가임기 계산기 — 연세365산부인과의원',
...
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'배란일 계산기 | 가임기·배란일 자동 계산', url:'https://www.yeonsei365.com/ovulation-calculator', specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, about:{'@type':'MedicalCondition',name:'배란일 계산'} }
const howToSchema = { '@context':'https://schema.org','@type':'HowTo', name:'배란일 계산하는 방법', description:'생리 시작일과 주기로 배란일·가임기 계산', step:[ {'@type':'HowToStep',position:1,name:'생리 시작일 입력',text:'마지막 생리 시작일을 입력합니다.'}, {'@type':'HowToStep',position:2,name:'생리주기 입력',text:'본인의 평균 생리주기(일수)를 입력합니다.'}, {'@type':'HowToStep',position:3,name:'배란일 확인',text:'배란일·가임기가 자동 계산됩니다. 정확한 확인은 연세365산부인과의원(02-585-3650)에서 초음파로 하세요.'} ], tool:{'@type':'HowToTool',name:'연세365산부인과의원'} }
const speakableSchema = { '@context':'https://schema.org','@type':'WebPage', name:'배란일 계산기 가임기 배란일 자동 계산 연세365산부인과의원', url:PAGE_URL, speakable:{'@type':'SpeakableSpecification',cssSelector:['h1','h2']} }
