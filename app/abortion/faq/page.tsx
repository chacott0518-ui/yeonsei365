...
export const metadata: Metadata = {
  title: '임신중절수술 FAQ | 낙태 비용 가격 자주 묻는 질문 217가지 | 연세365산부인과의원',
  description:
    '임신중절수술 비용·금액·가격, 수술 방법, 주수별 기간, 수술 전 준비, 수술 후 관리, 법적 기준까지 자주 묻는 질문 217가지를 직접 답변합니다. 사당역 4번출구 연세365산부인과의원.',
  keywords: [
  ...
  openGraph: {
    title: '임신중절수술 FAQ | 낙태 비용 가격 자주 묻는 질문 217가지 | 연세365산부인과의원',
    description: '임신중절수술 비용·방법·후관리 자주 묻는 질문 217가지. 사당역 연세365산부인과의원.',
...
const articleSchema = { '@context':'https://schema.org','@type':'Article', headline:'임신중절수술 FAQ | 낙태 비용 가격 자주 묻는 질문 217가지', datePublished:PAGE_DATE, dateModified:PAGE_MODIFIED, image:'https://www.yeonsei365.com/og-image.jpg', author:{'@type':'Organization','@id':'https://www.yeonsei365.com/#organization',name:'연세365산부인과의원',url:'https://www.yeonsei365.com'}, publisher:{'@type':'MedicalOrganization','@id':'https://www.yeonsei365.com/#organization',name:'연세365산부인과의원',logo:{'@type':'ImageObject',url:'https://i.imgur.com/f7h5DY0.png'}}, mainEntityOfPage:{'@type':'WebPage','@id':PAGE_URL}, url:PAGE_URL }
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'임신중절수술 FAQ 자주 묻는 질문 217가지', url:PAGE_URL, specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, lastReviewed:PAGE_MODIFIED, provider:{'@id':'https://www.yeonsei365.com/#organization'}, about:{'@type':'MedicalCondition',name:'임신중절수술'} }
...
const speakableSchema = { '@context':'https://schema.org','@type':'WebPage', name:'임신중절수술 FAQ 자주 묻는 질문 217가지', url:PAGE_URL, speakable:{'@type':'SpeakableSpecification',cssSelector:['h1','h2']} }
