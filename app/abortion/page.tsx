...
export const metadata: Metadata = {
  title: '임신중절수술·임신중절클리닉 | 임신중절수술 금액·비용·가격·후기·병원·방법·합법·혼자·당일 | 낙태비용가격·낙태수술·낙태합법화·낙태금액·낙태가격 | 임신초기중절수술·약물중절·인공임신중절 | 연세365산부인과의원',
  description:
    '임신중절수술·임신중절클리닉 전문. 임신중절수술 금액·비용·가격 주수별 투명 공개(8주 미만 45만원~). 임신중절수술 후기·병원·방법·합법 안내. 낙태비용가격·낙태수술·낙태합법화·낙태금액 총정리. 임신초기중절수술·약물중절·인공임신중절 안내. 당일 예약·수술 가능. 비밀보장. 사당역 4번출구 연세365산부인과의원 02-585-3650.',
  keywords: [
  ...
  openGraph: {
    title: '임신중절수술·임신중절클리닉 | 임신중절수술 금액·비용·가격·후기·병원·방법·합법·혼자·당일 | 낙태비용가격·낙태수술·낙태합법화·낙태금액·낙태가격 | 연세365산부인과의원',
    description: '임신중절수술·임신중절클리닉 전문. 임신중절수술 금액·비용·가격 주수별 투명 공개(8주 미만 45만원~). 임신중절수술 후기·병원·방법·합법 안내. 낙태비용가격·낙태금액 총정리. 당일 예약·수술 가능. 사당역 연세365산부인과의원 02-585-3650.',
    url: PAGE_URL,
    images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630, alt: '임신중절수술 임신중절클리닉 연세365산부인과의원' }],
    locale: 'ko_KR',
    type: 'website',
  },
  twitter: {
