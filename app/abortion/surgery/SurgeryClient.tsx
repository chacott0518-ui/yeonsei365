 ...
 · <ViewCounter slug="abortion-surgery" />
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 40px 100px' }}>
          ...
          <section>
            ...
            <p style={{ fontSize: '14px', color: C.ts, lineHeight: 2, letterSpacing: '-.01em', marginBottom: '14px' }}>
              연세365산부인과의원은 마취 전 환자의 체중, 나이, 건강 상태, 과거 마취 경험 등을 종합적으로 고려하여 가장 적절한 마취 용량을 정밀하게 계산합니다. 수술 전 혈액 검사로 마취에 영향을 줄 수 있는 요인들을 미리 확인하며, 마취 중에는 혈압, 심박수, 혈중 산소 포화도, 체온을 지속적으로 모니터링합니다.
            </p>
            <p style={{ fontSize: '14px', color: C.ts, lineHeight: 2, letterSpacing: '-.01em', marginBottom: '20px' }}>
          ...
          <section>
            ...
            <p style={{ fontSize: '14px', color: C.ts, lineHeight: 2, letterSpacing: '-.01em', marginBottom: '14px' }}>
              임신중절수술의 안전성은 집도의의 전문성, 마취 시스템, 응급 대처 능력에 달려 있습니다. 연세365산부인과의원은 산부인과 전문의가 모든 수술을 직접 집도하며, 풍부한 임상 경험을 바탕으로 각 환자의 상태에 맞는 최적의 수술 방법을 선택합니다.
            </p>
            <p style={{ fontSize: '14px', color: C.ts, lineHeight: 2, letterSpacing: '-.01em', marginBottom: '14px' }}>
            ...
            <p style={{ fontSize: '14px', color: C.ts, lineHeight: 2, letterSpacing: '-.01em', marginBottom: '20px' }}>
              연세365산부인과의원은 비전문의 대리 수술, 무허가 약물 사용, 부적절한 마취 시행 등 불법·비윤리적 행위를 일절 하지 않습니다. 모든 과정은 의료법과 의학 표준 지침에 따라 진행되며, 환자의 안전이 최우선입니다.
            </p>
