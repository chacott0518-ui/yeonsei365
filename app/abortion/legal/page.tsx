...
export const metadata: Metadata = {
  title: '낙태 합법화 안내 | 임신중절수술 합법 시기·기간·금액 | 연세365산부인과의원',
  description:
    '낙태 합법화가 궁금하신가요? 2021년 낙태죄 폐지 이후 임신중절수술 합법 시기와 기간을 정확히 안내합니다. 낙태 비용 가격·임신중절수술 금액·비용까지 한눈에 확인하세요. 사당역 연세365산부인과의원.',
  keywords: [
    '낙태합법화', '낙태시기', '낙태기간', '낙태법',
  ...
  openGraph: {
    title: '낙태 합법화 안내 | 임신중절수술 합법 시기·기간·금액 | 연세365산부인과의원',
    description: '낙태 합법화, 낙태죄 폐지 후 임신중절 합법 기준·금액 안내. 사당역 연세365산부인과의원.',
    url: 'https://www.yeonsei365.com/abortion/legal',
    images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630, alt: '낙태 합법화 임신중절수술 금액 연세365산부인과의원' }],
    locale: 'ko_KR',
    type: 'website',
  },
  twitter: {
...
const articleSchema = { '@context':'https://schema.org','@type':'Article', headline:'낙태 합법화 안내 | 임신중절수술 합법 시기·기준 완벽 정리', datePublished:PAGE_DATE, dateModified:PAGE_MODIFIED, image:'https://www.yeonsei365.com/og-image.jpg', author:{'@type':'Organization',name:'연세365산부인과의원',url:'https://www.yeonsei365.com'}, publisher:{'@type':'MedicalOrganization',name:'연세365산부인과의원',logo:{'@type':'ImageObject',url:'https://i.imgur.com/f7h5DY0.png'}}, mainEntityOfPage:{'@type':'WebPage','@id':PAGE_URL}, url:PAGE_URL }
...
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'낙태 합법화 안내 | 임신중절수술 합법 시기·기준', url:PAGE_URL, specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, about:{'@type':'MedicalCondition',name:'임신중절수술 합법 기준'} }
const howToSchema = { '@context':'https://schema.org','@type':'HowTo', name:'합법적 임신중절수술 진행 방법', description:'합법적으로 임신중절수술을 받는 4단계', step:[ {'@type':'HowToStep',position:1,name:'신분 확인',text:'신분증 지참 필수. 본인 확인 후 진행합니다.'}, {'@type':'HowToStep',position:2,name:'동의서 작성',text:'충분한 설명 후 서면 동의를 구합니다.'}, {'@type':'HowToStep',position:3,name:'초음파 진단',text:'정확한 주수 확인 후 방법을 결정합니다.'}, {'@type':'HowToStep',position:4,name:'합법 시술',text:'산부인과 전문의가 안전하게 집도합니다.'} ], tool:{'@type':'HowToTool',name:'연세365산부인과의원'} }
