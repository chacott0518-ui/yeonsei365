...
export const metadata: Metadata = {
  title: '임신중절수술 보호자·보험 안내 | 낙태 비용 가격 보험적용 | 연세365산부인과의원',
  description:
    '임신중절수술 보호자 동반이 필요한지 궁금하신가요? 성인은 혼자 가능하며 미성년자는 법정대리인 동의가 필요합니다. 낙태 비용 가격 보험 적용 여부, 임신중절수술 금액·비용도 함께 안내합니다. 사당역 연세365산부인과의원.',
  keywords: [
  ...
  openGraph: {
    title: '임신중절수술 보호자·보험 안내 | 낙태 비용 가격 보험적용 | 연세365산부인과의원',
    description: '임신중절수술 보호자 여부, 낙태 비용 가격 보험 적용 안내. 사당역 연세365산부인과의원.',
    url: 'https://www.yeonsei365.com/abortion/info',
    images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630, alt: '임신중절수술 보호자 보험 안내 연세365산부인과의원' }],
    locale: 'ko_KR',
    type: 'website',
  },
  twitter: {
...
const articleSchema = { '@context':'https://schema.org','@type':'Article', headline:'임신중절수술 보호자·보험 안내 | 혼자 가능 여부 완벽 정리', datePublished:PAGE_DATE, dateModified:PAGE_MODIFIED, image:'https://www.yeonsei365.com/og-image.jpg', author:{'@type':'Organization',name:'연세365산부인과의원',url:'https://www.yeonsei365.com'}, publisher:{'@type':'MedicalOrganization',name:'연세365산부인과의원',logo:{'@type':'ImageObject',url:'https://i.imgur.com/f7h5DY0.png'}}, mainEntityOfPage:{'@type':'WebPage','@id':PAGE_URL}, url:PAGE_URL }
...
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'임신중절수술 보호자·보험 안내', url:PAGE_URL, specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, about:{'@type':'MedicalCondition',name:'임신중절수술'} }
const howToSchema = { '@context':'https://schema.org','@type':'HowTo', name:'임신중절수술 당일 준비 방법', description:'수술 당일 준비사항 단계별 안내', step:[ {'@type':'HowToStep',position:1,name:'금식',text:'수술 6시간 전부터 물 포함 완전 금식합니다.'}, {'@type':'HowToStep',position:2,name:'신분증 지참',text:'주민등록증 또는 운전면허증을 반드시 지참합니다.'}, {'@type':'HowToStep',position:3,name:'귀가 방법 확인',text:'수면마취 후 자가 운전 불가. 대중교통 이용 또는 보호자 동반.'} ], tool:{'@type':'HowToTool',name:'연세365산부인과의원'} }
