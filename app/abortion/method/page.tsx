...
export const metadata: Metadata = {
  title: '임신중절수술 방법·종류 | 낙태 비용 가격·흡입술·소파술 | 연세365산부인과의원',
  description:
    '임신중절수술 방법이 궁금하신가요? 흡입술, 소파술, 약물중절 방법을 주수별로 비교 안내합니다. 낙태 비용 가격·임신중절수술 금액·비용까지 한눈에 확인하세요. 사당역 연세365산부인과의원.',
  keywords: [
  ...
  openGraph: {
    title: '임신중절수술 방법·종류 | 낙태 비용 가격·흡입술·소파술 | 연세365산부인과의원',
    description: '임신중절수술 방법 흡입술·소파술·약물중절 비교. 낙태 비용 가격 안내. 사당역 연세365산부인과의원.',
    url: 'https://www.yeonsei365.com/abortion/method',
    images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630, alt: '임신중절수술 방법 낙태 비용 가격 연세365산부인과의원' }],
    locale: 'ko_KR',
    type: 'website',
  },
  twitter: {
...
const articleSchema = { '@context':'https://schema.org','@type':'Article', headline:'임신중절수술 방법·종류 | 흡입술·소파술·약물중절 완전 비교', datePublished:PAGE_DATE, dateModified:PAGE_MODIFIED, image:'https://www.yeonsei365.com/og-image.jpg', author:{'@type':'Organization',name:'연세365산부인과의원',url:'https://www.yeonsei365.com'}, publisher:{'@type':'MedicalOrganization',name:'연세365산부인과의원',logo:{'@type':'ImageObject',url:'https://i.imgur.com/f7h5DY0.png'}}, mainEntityOfPage:{'@type':'WebPage','@id':PAGE_URL}, url:PAGE_URL }
...
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'임신중절수술 방법·종류 흡입술·소파술·약물중절', url:PAGE_URL, specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, about:{'@type':'MedicalCondition',name:'임신중절수술 방법'} }
