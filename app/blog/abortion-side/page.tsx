...
export const metadata: Metadata = {
  title: '임신중절수술 부작용 | 위험성·합병증 완벽 안내 2026 | 연세365산부인과의원',
  ...
  openGraph: { title: '임신중절수술 부작용 | 연세365산부인과의원', description: '임신중절수술 부작용·합병증 완벽 안내. 사당역 4번 출구.', url: 'https://www.yeonsei365.com/blog/abortion-side', images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630 }] },
...
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'임신중절수술 부작용 | 위험성·합병증 완벽 안내 2026', url:PAGE_URL, specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, about:{'@type':'MedicalCondition',name:'임신중절수술 부작용'} }
  ...
  return (
    <>
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '0 20px 100px', fontFamily: '"Pretendard", -apple-system, sans-serif' }}>
        <div style={{ margin: '28px 0 0' }}><img src="/og-image.jpg" alt="임신중절수술 부작용 합병증 연세365산부인과의원" width="780" height="410" style={{ width: '100%', borderRadius: '18px', display: 'block' }} /></div>
        <div style={{ background: `linear-gradient(160deg, ${C.pp} 0%, ${C.pd} 40%, ${C.p} 100%)`, borderRadius: '20px', padding: 'clamp(24px,5vw,40px) clamp(20px,5vw,36px)', margin: '20px 0 28px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '20px', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: '180px' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.88)', fontSize: 'clamp(12px,3vw,14px)', lineHeight: 1.8, margin: 0 }}>부작용 종류, 위험도, 예방법, 즉시 내원 증상까지 전문의가 투명하게 안내합니다. · <ViewCounter slug="blog-abortion-side" /></p>
            </div>
