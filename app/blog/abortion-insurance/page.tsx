...
export const metadata: Metadata = {
  title: '임신중절수술 보험 | 실손보험 적용 여부 완벽 안내 2026 | 연세365산부인과의원',
  ...
  openGraph: { title: '임신중절수술 보험 | 실손보험 적용 여부 | 연세365산부인과의원', description: '임신중절수술 보험 적용 여부 완벽 안내. 사당역 4번 출구.', url: 'https://www.yeonsei365.com/blog/abortion-insurance', images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630 }] },
...
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'임신중절수술 보험 | 실손보험 적용 여부 완벽 안내 2026', url:PAGE_URL, specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, about:{'@type':'MedicalCondition',name:'임신중절수술 보험 적용'} }
...
<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(clinicSchema) }} />
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '0 20px 100px', fontFamily: '"Pretendard", -apple-system, sans-serif' }}>
        <div style={{ margin: '28px 0 0' }}><img src="/og-image.jpg" alt="임신중절수술 보험 실손보험 연세365산부인과의원" width="780" height="410" style={{ width: '100%', borderRadius: '18px', display: 'block' }} /></div>
