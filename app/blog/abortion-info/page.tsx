...
export default function AbortionInfoPage() {
  return (
    <>
      ...
      <header style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50, background: 'rgba(255,255,255,0.95)', backdropFilter: 'blur(8px)', borderBottom: '1px solid #FFD0A0', padding: '14px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          <a href="/blog" style={{ fontSize: '13px', color: '#FF6600', textDecoration: 'none', fontWeight: 600 }}>임신중절수술정보</a>
