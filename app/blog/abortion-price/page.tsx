...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    '낙태비용후기', '낙태비용보험', '낙태수술비용', '낙태수술금액',
    '낙태수술가격', '낙태수술병원', '낙태병원',
    '낙태뜻', '낙태시기', '낙태합법화', '낙태합법', '낙태법',
    '낙태방법', '낙태기간', '낙태후기', '낙태후유증',
    '임신중절수술비용', '임신중절수술금액', '임신중절수술가격',
    '임신중절수술병원', '임신중절합법', '임신중절수술합법기간',
    '임신중절비용', '임신중절금액', '임신중절가격',
    '임신중절수술', '임신중절수술뜻', '임신중절수술후기',
    '임신중절수술기간', '임신중절수술합법', '임신중절수술후관리',
    '임신중절수술후생리', '임신중절흡입술',
    '임신초기중절수술가격', '임신초기중절수술금액', '임신초기중절수술병원',
    '임신초기중절수술비용', '임신초기중절수술약물', '임신초기중절수술부작용',
    '임신초기중절수술후', '임신초기중절수술후관리', '임신초기중절수술후기',
    '임신초기낙태가격', '임신초기낙태금액', '임신초기낙태비용',
    '임신초기낙태수술', '임신초기낙태병원', '임신초기낙태후기',
    '임신초기낙태보호자', '임신초기낙태부작용', '임신초기낙태시기',
    '임신초기낙태후유증', '임신초기낙태후임신', '임신초기낙태',
    '중절수술가격', '중절수술금액', '중절수술비용', '중절수술병원',
    '중절수술병원금액', '중절수술병원비용', '중절수술병원가격',
    '중절수술병원예약', '중절수술병원찾기', '중절수술병원후기',
    '중절수술후관리', '중절수술후기', '중절수술후생리', '중절수술보험',
    '중절수술보호자', '중절수술후음식', '중절수술후음주',
    '중절수술후임신', '중절수술후술', '중절수술후출혈', '중절수술후통증',
    '약물중절금액', '약물중절비용', '약물중절후기', '약물중절가격',
    '약물중절방법', '약물중절MTX', '서울중절수술병원',
    '관악구낙태병원', '사당역산부인과', '흡입식소파술비용',
    '여성검진클리닉', '여성검진', '미혼여성검진', '웨딩검진',
    '난임클리닉', '난임치료', '소음순성형', '질성형',
    '질레이저', '질건조증', '요실금치료', '갱년기', '폐경',
...
const medicalWebPageSchema = { '@context':'https://schema.org','@type':'MedicalWebPage', name:'낙태 비용 가격 총정리 2026 | 주수별 가격 완벽 공개', url:PAGE_URL, specialty:{'@type':'MedicalSpecialty',name:'산부인과'}, medicalAudience:{'@type':'MedicalAudience',audienceType:'여성 환자'}, about:{'@type':'MedicalCondition',name:'낙태 비용'} }
