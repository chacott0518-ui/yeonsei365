...
export const metadata: Metadata = {
  title: '임신중절수술 비용 완벽 정리 2026 | 주수별 가격·과정·주의사항 | 연세365산부인과의원',
  description:
    ...
    keywords: [
      ...
      '흡입식소파술비용', '중절수술병원금액', '중절수술병원비용',
      // 여성클리닉
      '여성검진클리닉', '여성검진', '미혼여성검진', '웨딩검진',
      '갱년기검진', '산전관리', '임신준비검진',
      '난임클리닉', '난임치료', '배란유도', '인공수정',
      '소음순성형', '질성형', '여성성형',
      '질레이저', '질건조증', '요실금치료',
      '갱년기', '폐경', '호르몬치료',
      '자궁근종', '난소종양', '하이푸',
  ...
  openGraph: {
    title: '임신중절수술 비용 완벽 정리 2026 | 연세365산부인과의원',
...
function PriceImage45() {
  return (
    <div style={{ maxWidth: '400px', margin: '0 auto' }}>
      <img
        src="/price-main.png"
        alt="임신중절수술비용 낙태비용 낙태금액 낙태가격 임신중절비용 임신중절금액 임신중절가격 당일예약 당일퇴원 45만원 연세365산부인과의원"
        width="400"
        height="400"
...
<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(clinicSchema) }} />
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '40px 20px 80px', fontFamily: 'Pretendard, sans-serif', color: '#1A0A10', lineHeight: 1.8 }}>
        ...
        {[
          ...
          { q: '수술 예약은 어떻게 하나요?', a: '전화(02-585-3650) 또는 카카오톡 채널(연세365산부인과의원)로 상담 및 예약이 가능합니다. 당일 예약 및 당일 수술도 가능하니 편하게 연락 주세요.' },
