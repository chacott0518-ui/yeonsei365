...
const SCHEMA = {
  ...
  '@type': 'MedicalWebPage',
  name: '산부인과 증상 자가진단 퀴즈 | 연세365산부인과의원',
...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: '임신 가능성을 먼저 확인하고, 아니라면 조기 폐경, 시상하부-뇌하수체 이상, 극도의 체중 감소 등 다양한 원인을 검사해야 합니다. 사당역 연세365산부인과의원(02-585-3650)에 내원하여 정확한 진단을 받으세요.' },
    },
    {
      '@type': 'Question',
...
export const metadata: Metadata = {
  title: '산부인과 증상 자가진단 퀴즈 | 3단계 맞춤 진단 | 연세365산부인과의원',
  description: '생리불순·임신·통증·검진 등 산부인과 증상을 3단계 자가진단으로 확인하세요. 전문의 기준의 맞춤 가이드를 바로 확인할 수 있습니다. 사당역 4번출구 연세365산부인과의원.',
  keywords: [
  ...
  openGraph: {
    title: '산부인과 증상 자가진단 퀴즈 | 연세365산부인과의원',
    description: '3단계 자가진단으로 내 증상을 확인하고 전문의 맞춤 가이드를 받아보세요.',
    url: 'https://www.yeonsei365.com/health-magazine/quiz',
    images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630, alt: '연세365산부인과의원 산부인과 자가진단 퀴즈' }],
    locale: 'ko_KR',
    type: 'website',
  },
  twitter: {
...
const articleSchema = { '@context':'https://schema.org','@type':'Article', headline:'산부인과 증상 자가진단 퀴즈 | 3단계 맞춤 진단 | 연세365산부인과의원', datePublished:PAGE_DATE, dateModified: PAGE_MODIFIED, image:'https://www.yeonsei365.com/og-image.jpg', author:{'@type':'Organization',name:'연세365산부인과의원',url:'https://www.yeonsei365.com'}, publisher:{'@type':'MedicalOrganization',name:'연세365산부인과의원',logo:{'@type':'ImageObject',url:'https://i.imgur.com/f7h5DY0.png'}}, mainEntityOfPage:{'@type':'WebPage','@id':PAGE_URL}, url:PAGE_URL }
...
const speakableSchema = { '@context':'https://schema.org','@type':'WebPage', name:'산부인과 증상 자가진단 퀴즈 3단계 맞춤 진단 연세365산부인과의원', url:PAGE_URL, speakable:{'@type':'SpeakableSpecification',cssSelector:['h1','h2']} }
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: '임신중절수술 진행 과정',
