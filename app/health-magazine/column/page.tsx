...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.yeonsei365.com/health-magazine/column',
    images: [{ url: 'https://www.yeonsei365.com/og-image.jpg', width: 1200, height: 630, alt: '연세365산부인과의원 여성 건강 칼럼' }],
...
const speakableSchema = { '@context':'https://schema.org','@type':'WebPage', name:'여성 건강 칼럼 자궁근종 임신 산부인과 전문의 칼럼 연세365산부인과의원', url:PAGE_URL, speakable:{'@type':'SpeakableSpecification',cssSelector:['h1','h2']} }
const faqSchema = {
  '@context': 'https://schema.org',
  '@type': 'FAQPage',
  mainEntity: [
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: '연세365산부인과의원 헬스매거진 칼럼은 임신중절수술 비용·방법·후기, 피임, 여성 건강 등 산부인과 전문 정보를 다룹니다. 02-585-3650으로 직접 상담도 가능합니다.' },
    },
    {
      '@type': 'Question',
      name: '임신중절수술 비용이 얼마인가요?',
      acceptedAnswer: { '@type': 'Answer', text: '임신중절수술 비용은 8주 미만 45만원, 8주 60만원, 9주 70만원, 10주 80만원입니다. 연세365산부인과의원(02-585-3650)에서 정확한 비용을 안내드립니다.' },
    },
    {
      '@type': 'Question',
      name: '당일 임신중절수술이 가능한가요?',
      acceptedAnswer: { '@type': 'Answer', text: '네, 연세365산부인과의원은 당일 검사·상담·수술이 가능한 원스톱 시스템을 운영합니다. 사당역 4번출구 도보 3분입니다.' },
    },
    {
      '@type': 'Question',
