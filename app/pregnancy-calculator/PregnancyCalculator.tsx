...
const FAQS=[
  ...
  {q:'임신중절수술 비용(낙태 비용)은 얼마인가요?',a:'임신중절수술 비용은 임신 주수와 시술 방법에 따라 다릅니다. 연세365산부인과의원 기준으로 8주 미만 45만원, 8주 60만원, 9주 70만원, 10주 80만원이며 양양제·1인 회복실·현금/카드 동일·부가세가 포함된 금액입니다. 주수가 늘어날수록 비용이 올라가므로 결정하셨다면 빠를수록 비용과 위험 모두 줄일 수 있습니다. 익명 상담 및 비밀 보장이 가능합니다.'},
