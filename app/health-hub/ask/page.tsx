...
const faqSchema = { '@context':'https://schema.org','@type':'FAQPage', mainEntity:[ {'@type':'Question',name:'산부인과 질문을 어떻게 남기나요?',acceptedAnswer:{'@type':'Answer',text:'카테고리 선택 후 질문을 10자 이상 입력하고 제출하면 AI 답변이 Q&A 페이지에 게시됩니다. 연세365산부인과의원(02-585-3650)로 직접 문의도 가능합니다.'}}, {'@type':'Question',name:'질문 답변은 얼마나 걸리나요?',acceptedAnswer:{'@type':'Answer',text:'AI 답변이 자동 생성되며 보통 수분 이내 게시됩니다.'}} ] }
