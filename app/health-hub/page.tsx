...
const faqSchema = { '@context':'https://schema.org','@type':'FAQPage', mainEntity:[ {'@type':'Question',name:'산부인과 건강 Q&A는 어디서 확인하나요?',acceptedAnswer:{'@type':'Answer',text:'사당역 연세365산부인과의원 AI 건강허브에서 임신·피임·산부인과 질환·수술·여성건강 관련 일반 건강정보 Q&A를 확인하실 수 있습니다.'}}, {'@type':'Question',name:'직접 질문을 남길 수 있나요?',acceptedAnswer:{'@type':'Answer',text:'네, 질문을 남기시면 AI 답변이 Q&A 페이지에 게시됩니다. 연세365산부인과의원(02-585-3650)로 직접 문의도 가능합니다.'}} ] }
