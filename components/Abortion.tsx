...
const diagnosisMethods = [
  {
    ...
    alt: '소변 임신테스트기를 이용한 자가 임신 확인 방법 안내 - 연세365산부인과'
  },
  {
    id: 2,
    title: '혈액 검사',
    ...
    alt: '산부인과 혈액 검사를 통한 정밀 임신 확인 및 주수 판정 - 연세365산부인과'
  },
  {
    id: 3,
    title: '초음파 검사',
    ...
    alt: '초음파 검사로 정확한 임신 주수 확인 및 정상 임신 진단 - 연세365산부인과'
  }
];
...
const faqs = [
  ...
  },
  {
    ...
    a: '낙태비용가격은 임신 주수가 가장 큰 결정 요인입니다. 임신 8주 미만의 초기에는 중절수술가격이 45만원 수준으로 가장 낮은 가격대이며, 8주·9주·10주로 주수가 증가할수록 수술의 복잡도와 마취 시간이 늘어나 임신중절수술비용이 점진적으로 높아집니다. 이는 태아의 크기와 자궁 상태 변화에 따라 보다 정밀한 시술이 요구되기 때문입니다. 낙태수술가격은 수술 방법(흡입식소파술, 임신중절소파술 등)에 따라서도 달라질 수 있으며, 임신중절수술가격은 사전 상담에서 명확히 안내드립니다. 연세365산부인과는 주수별 낙태비용가격을 사전에 명확히 안내드리며, 상담 후 추가 비용이 발생하지 않는 투명한 가격 정책을 시행하고 있습니다.'
  },
  {
  ...
  },
  {
    ...
    a: '임신중절수술 방법은 임신 주수에 따라 가장 안전한 방식이 달라집니다. 임신 초기(7주 이내)에는 흡입식소파술을 주로 시행하며, 그 이후에는 임신중절소파술(경관확장 소파술)을 진행합니다. 연세365산부인과는 모든 수술에 일회용 멸균 기구만을 사용하여 감염 위험을 원천 차단하고, 풍부한 임상 경험을 가진 산부인과 전문의가 자궁 내막 손상을 최소화하는 정밀한 수술을 직접 시행합니다. 수술 전 충분한 설명과 동의 과정을 거치며, 환자분의 건강 상태에 따라 최적의 낙태수술 방법을 제안해드립니다.'
  },
  {
  ...
  },
  {
    ...
    a: '임신중절수술 후 다음 생리까지 성관계를 피하셔야 합니다. 자궁 내막이 완전히 회복되기 전 성관계를 하면 세균 감염 위험이 크게 높아지며, 자궁 회복에도 악영향을 줄 수 있습니다. 일반적으로 수술 후 첫 월경이 돌아온 이후(약 4~6주)부터 정상적인 성생활이 가능하며, 이후에도 반드시 피임을 실천하시기 바랍니다. 연세365산부인과에서는 낙태수술 후 경과 확인을 위한 후속 진료를 안내드리고 있으니, 회복 상태에 대해 궁금하신 점이 있으시면 언제든 연락해주세요.'
  },
  {
  ...
  {
    q: 'Q. 연세365산부인과는 어디에 있으며, 어떤 지역에서 많이 내원하시나요?',
    a: '연세365산부인과는 사당역 4번출구 바로 앞에 위치하여 대중교통 접근성이 매우 뛰어납니다. 지하철 2호선과 4호선이 교차하는 사당역 특성상 관악구 산부인과, 신림동 산부인과, 과천 산부인과를 찾으시는 분들은 물론, 강남역 산부인과·신논현역 산부인과·서초동 산부인과를 찾으시는 분들도 편리하게 내원하실 수 있어 강남 임신중절수술을 고려하시는 분들께서도 많이 찾아주고 계십니다. 연중무휴 산부인과로 운영되며, 주말과 공휴일에도 진료가 가능합니다. 임신중절가격과 낙태수술가격은 임신 주수에 따라 달라지며, 낙태비용금액에 대한 정확한 안내는 초음파 검사 후 1:1 상담에서 투명하게 제공됩니다. 임신중절수술후기가 궁금하시다면, 상담 시 수술 과정과 회복에 대해 경험 많은 전문의가 상세히 설명드립니다.'
  },
  {
    q: 'Q. 낙태수술 후 빈혈이 올 수 있나요?',
    a: '수술 과정에서 발생하는 불가피한 출혈이나 체력 소모로 인해 일시적인 어지럼증이나 빈혈 증상이 나타날 수 있습니다. 특히 평소 빈혈 수치가 낮았던 분들은 수술 후 철분 수치가 급격히 떨어질 수 있어 각별한 주의가 필요합니다. 연세365산부인과에서는 수술 전후 혈액 검사를 통해 환자분의 상태를 면밀히 파악하며, 필요한 경우 고농축 철분 주사나 맞춤형 영양 수액을 처방하여 신속한 회복을 돕고 있습니다. 수술 후 약 2주간은 균형 잡힌 식단과 함께 철분 섭취에 신경 써주시는 것이 일상 복귀에 큰 도움이 됩니다.'
  },
];
        ...
        <div className="md:hidden">
          ...
          <div className="mt-8 bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-5 border border-primary/10">
            ...
            <p className="text-[10px] text-gray-500 leading-[1.7]">
              ※ <strong className="text-gray-600">임신중절수술</strong>은 <strong className="text-gray-600">임신중절수술합법</strong> 시행 기관에서 안전하게 진행해야 합니다. 연세365산부인과는 <strong className="text-gray-600">24시간 상담 시스템</strong>과 <strong className="text-gray-600">1:1 프라이빗 상담</strong>을 통해 환자분의 상황에 맞는 최적의 방법을 안내드립니다.
            </p>
          </div>
        ...
        <div className="hidden md:block">
          ...
          <div id="ab-diagnosis" className="max-w-5xl mx-auto mb-16 scroll-mt-20">
            <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8 md:p-12 border border-primary/10 text-center">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 max-w-3xl mx-auto">
                연세365산부인과는 의료법과 모자보건법을 철저히 준수하며, 풍부한 임상 경험을 가진 산부인과 전문의가
                <br />
              ...
              <p className="text-gray-600 leading-relaxed mb-8 max-w-3xl mx-auto text-sm">
                사당역에 위치한 연세365산부인과는 <strong>관악구 산부인과</strong>, <strong>신림동 산부인과</strong>, <strong>과천 산부인과</strong>를 찾으시는 분들은 물론,
                <br />
              ...
              <div className="bg-white/80 rounded-xl p-6 backdrop-blur-sm max-w-3xl mx-auto text-left">
                ...
                <p className="mt-4 text-xs text-gray-500 text-center leading-relaxed">
                  ...
                  <br />
                  연세365산부인과는 <strong>당일 수술 및 퇴원</strong>이 가능하며, <strong>철저한 비밀 보장</strong> 하에 모든 진료가 진행됩니다.
                </p>
              </div>
            </div>
          </div>
