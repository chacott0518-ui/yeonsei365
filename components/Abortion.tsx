...
const afterCare = [
  ...
  { id: 2, title: '낙태수술 후 최소 2주간 무리한 운동, 사우나, 성관계를 삼가고 충분한 안정을 취해주세요.', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&q=80', alt: '낙태수술 후 회복 기간 안내 - 최소 2주간 안정 권고' },
...
const faqs = [
  ...
  },
  {
    ...
    a: '약물중절은 약물(미페프리스톤, 미소프로스톨 등)을 복용하여 수술 없이 임신을 종료하는 약물중절방법입니다. 약물중절후기에서 비교적 간편하다는 의견이 있으나, 현재 국내에서는 미프진 등 약물중절 약제가 공식 허가되지 않아 인증되지 않은 경로를 통한 약물중절은 불완전 유산, 대량 출혈, 감염 등 심각한 부작용 위험이 있습니다. 약물중절가격이 저렴해 보일 수 있으나, 부작용 발생 시 응급 수술이 필요할 수 있어 오히려 비용과 건강상의 부담이 커질 수 있습니다. 연세365산부인과는 안전한 약물중절병원이자 중절수술병원으로서, 환자의 임신 주수와 건강 상태에 따라 흡입식소파술 또는 임신중절소파술 등 가장 안전한 임신초기중절수술 방법을 1:1 프라이빗 상담에서 안내드립니다.'
  },
  {
  ...
  {
    q: 'Q. 마취과 전문의가 함께 하나요? 당일 수술 및 퇴원이 가능한가요?',
    a: '네, 연세365산부인과에서는 마취과 전문의 협진 하에 수면마취를 진행하여 수술 중 환자의 안전을 철저히 보장합니다. 마취과 전문의가 수술 전 환자의 건강 상태를 평가하고, 수술 중 활력 징후를 실시간으로 모니터링하며 마취 깊이를 정밀하게 조절합니다. 당일 수술 및 퇴원이 가능한 원스톱 시스템을 운영하고 있어, 내원 당일 검사·1:1 프라이빗 상담·수술까지 한 번에 진행하실 수 있습니다. 수술 후에는 전용 회복실에서 영양수액 처치와 함께 충분한 휴식을 취하신 후 당일 귀가하실 수 있습니다. 수술 후 사후관리 프로그램을 통해 회복 경과를 꼼꼼히 추적 관리하며, 24시간 상담 시스템을 운영하여 퇴원 후에도 이상 증상 발생 시 즉시 연락하실 수 있습니다.'
  },
  {
          ...
          <div id="ab-diagnosis" className="max-w-5xl mx-auto mb-16 scroll-mt-20">
            <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8 md:p-12 border border-primary/10 text-center">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 max-w-3xl mx-auto">
                ...
                <br />
                모든 수술은 <strong>마취과 전문의 협진</strong> 하에 수면마취로 안전하게 진행됩니다.
                <br />
