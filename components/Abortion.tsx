...
/* ================================================================
   Static Data — 컴포넌트 밖에 선언하여 JSON-LD useEffect 등에서 안정적 참조
   ================================================================ */

const DESKTOP_SECTION_IDS = ['ab-cost', 'ab-diagnosis', 'ab-procedure', 'ab-faq'];
...
const diagnosisMethods = [
  {
    ...
    alt: '소변 임신테스트기를 이용한 자가 임신 확인 방법 안내 - 연세365산부인과의원'
  },
  {
    id: 2,
    title: '혈액 검사',
    ...
    alt: '산부인과 혈액 검사를 통한 정밀 임신 확인 및 주수 판정 - 연세365산부인과의원'
  },
  {
    id: 3,
    title: '초음파 검사',
    ...
    alt: '초음파 검사로 정확한 임신 주수 확인 및 정상 임신 진단 - 연세365산부인과의원'
  }
];

const procedures = [
  { step: '01', title: '초음파 검사를 통한 정확한 임신 주수 확인 및 정상 임신 여부 진단 — 임신중절수술 방법과 비용을 결정하는 핵심 단계' },
  { step: '02', title: '혈액검사 등 개인별 건강 상태 정밀 확인 및 낙태수술 전 필수 사전 검사 진행' },
...
const afterCare = [
  { id: 1, title: '임신중절수술 전 최소 6시간 이상 금식(물 포함)이 필수이며, 마취 안전을 위해 반드시 지켜주세요.', image: 'https://images.unsplash.com/photo-1553531889-56cc480ac5cb?w=400&q=80', alt: '임신중절수술 전 금식 안내 - 안전한 마취를 위한 필수 준비사항' },
  { id: 2, title: '낙태수술 후 최소 2주간 무리한 운동, 사우나를 삼가고 충분한 안정을 취해주세요.', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&q=80', alt: '낙태수술 후 회복 기간 안내 - 최소 2주간 안정 권고' },
  { id: 3, title: '수술 후 첫 월경까지 개인차가 있으며 보통 4~6주 소요됩니다. 이상 증상 시 즉시 내원해주세요.', image: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=400&q=80', alt: '임신중절수술 후 월경 회복 안내 - 이상 증상 시 즉시 내원 안내' },
  { id: 4, title: '약물 알레르기·고혈압·당뇨 등 기저질환은 낙태수술 전 반드시 담당 의료진에게 알려주세요.', image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=400&q=80', alt: '낙태수술 전 기저질환 고지 안내 - 환자 안전을 위한 필수 확인사항' },
  { id: 5, title: '수술 후 과다 출혈이나 심한 복통 시 즉시 연락해주세요. 1:1 사후 케어로 회복까지 함께합니다.', image: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400&q=80', alt: '임신중절수술 후 응급 상황 대처 안내 - 1:1 사후 케어 시스템 운영' }
];
...
const faqs = [
  ...
  },
  {
    ...
    a: '낙태비용가격은 임신 주수가 가장 큰 결정 요인입니다. 임신 8주 미만의 초기에는 중절수술가격이 45만원 수준으로 가장 낮은 가격대이며, 8주·9주·10주로 주수가 증가할수록 수술의 복잡도와 마취 시간이 늘어나 임신중절수술비용이 점진적으로 높아집니다. 이는 태아의 크기와 자궁 상태 변화에 따라 보다 정밀한 시술이 요구되기 때문입니다. 낙태수술가격은 수술 방법(흡입식소파술, 임신중절소파술 등)에 따라서도 달라질 수 있으며, 임신중절수술가격은 사전 상담에서 명확히 안내드립니다. 연세365산부인과의원은 주수별 낙태비용가격을 사전에 명확히 안내드리며, 상담 후 추가 비용이 발생하지 않는 투명한 가격 정책을 시행하고 있습니다.'
  },
  {
    q: 'Q. 낙태수술 후 회복 기간은 얼마나 걸리나요?',
    a: '대부분의 환자분들은 낙태수술 당일 귀가가 가능하며, 다음 날부터 가벼운 일상생활을 시작하실 수 있습니다. 수술 후 1~2주 정도 소량의 출혈이 있을 수 있으며, 이는 자궁이 정상적으로 회복되는 과정에서 나타나는 자연스러운 현상입니다. 연세365산부인과의원에서는 임신중절수술 후 1:1 사후 케어 시스템을 운영하여 회복 경과를 꼼꼼히 확인하고, 이상 증상 발생 시 신속하게 대응합니다. 무리한 활동과 음주는 최소 2주간 피하시고, 충분한 휴식과 영양 섭취를 통해 빠른 회복을 도모하시기 바랍니다.'
  },
  {
    q: 'Q. 낙태수술은 당일 진행이 가능한가요?',
    a: '네, 연세365산부인과의원은 당일 검사·당일 상담·당일 낙태수술이 가능한 원스톱 시스템을 운영하고 있습니다. 내원 후 초음파 검사와 혈액 검사를 통해 정확한 임신 주수와 건강 상태를 확인한 뒤, 풍부한 임상 경험을 가진 산부인과 전문의와의 1:1 상담을 거쳐 바로 수술을 진행할 수 있습니다. 다만, 수술 전 최소 6시간 이상 금식이 필수이므로 아침 일찍 방문하시거나 전날 저녁부터 금식 후 내원해주시기 바랍니다. 사전 예약 시 대기 시간 없이 보다 원활한 당일 임신중절수술 진행이 가능합니다.'
  },
  {
    q: 'Q. 임신중절수술 후 향후 임신에 영향이 있나요?',
    a: '연세365산부인과의원은 자궁 내막 손상을 최소화하는 최신 수술 기법을 적용하여 안전한 임신중절수술을 시행하고 있습니다. 풍부한 임상 경험을 가진 산부인과 전문의가 직접 수술을 집도하며, 수술 후 적절한 회복 기간을 거치면 향후 임신과 출산에 큰 영향을 미치지 않습니다. 수술 후에는 최소 3개월간 피임을 권장드리며, 자궁의 완전한 회복 상태를 확인하기 위해 정기 검진을 받으시는 것이 좋습니다. 임신중절수술 후 재임신 계획이 있으시다면 담당 의료진과 충분히 상담해주세요.'
  },
  {
    q: 'Q. 미성년자도 낙태수술이 가능한가요?',
    a: '만 19세 미만 미성년자의 경우, 법정대리인(부모님 또는 법적 보호자)의 동의서가 필요합니다. 다만, 성폭력 피해 등 특별한 사유가 있는 경우에는 개별 상담을 통해 진행 가능 여부를 안내해드립니다. 연세365산부인과의원은 모든 상담 내용과 진료 기록을 철저히 비밀 보장하며, 프라이빗한 독립 상담실에서 1:1 맞춤 상담을 진행하고 있습니다. 미성년자 환자분도 심리적 부담 없이 편안하게 상담받으실 수 있도록 세심하게 배려합니다.'
  },
  {
    q: 'Q. 낙태수술 기록이 남거나 타인에게 알려질 수 있나요?',
    a: '의료법에 따라 환자의 모든 진료 기록은 절대적으로 비밀이 보장됩니다. 낙태수술 기록은 본인의 동의 없이는 가족, 직장, 보험사 등 어떠한 제3자에게도 열람이 불가능합니다. 연세365산부인과의원은 독립된 프라이빗 진료 공간에서 1:1 상담과 수술을 진행하며, 접수부터 퇴원까지 타 환자와의 동선이 겹치지 않도록 철저히 관리합니다. 임신중절수술과 관련된 모든 과정에서 환자분의 프라이버시를 최우선으로 보호하오니, 안심하고 내원해주시기 바랍니다.'
  },
  {
    q: 'Q. 임신중절수술 방법은 어떻게 되나요?',
    a: '임신중절수술 방법은 임신 주수에 따라 가장 안전한 방식이 달라집니다. 임신 초기(7주 이내)에는 흡입식소파술을 주로 시행하며, 그 이후에는 임신중절소파술(경관확장 소파술)을 진행합니다. 연세365산부인과의원은 모든 수술에 일회용 멸균 기구만을 사용하여 감염 위험을 원천 차단하고, 풍부한 임상 경험을 가진 산부인과 전문의가 자궁 내막 손상을 최소화하는 정밀한 수술을 직접 시행합니다. 수술 전 충분한 설명과 동의 과정을 거치며, 환자분의 건강 상태에 따라 최적의 낙태수술 방법을 제안해드립니다.'
  },
  {
  ...
  },
  {
    ...
    a: '임신중절수술 후 다음 생리까지 성관계를 피하셔야 합니다. 자궁 내막이 완전히 회복되기 전 성관계를 하면 세균 감염 위험이 크게 높아지며, 자궁 회복에도 악영향을 줄 수 있습니다. 일반적으로 수술 후 첫 월경이 돌아온 이후(약 4~6주)부터 정상적인 성생활이 가능하며, 이후에도 반드시 피임을 실천하시기 바랍니다. 연세365산부인과의원에서는 낙태수술 후 경과 확인을 위한 후속 진료를 안내드리고 있으니, 회복 상태에 대해 궁금하신 점이 있으시면 언제든 연락해주세요.'
  },
  {
    q: 'Q. 임신중절수술비용에 포함되는 항목은 무엇인가요?',
    a: '연세365산부인과의원의 임신중절수술비용에는 수술비, 마취비, 수술 후 영양수액 처치비가 모두 포함되어 있습니다. 현금과 카드 가격이 동일하며, 상담 시 안내받은 중절수술가격 외에 추가 비용은 발생하지 않습니다. 임신중절비용과 임신중절금액은 임신 주수에 따라 달라지며, 중절수술금액에 숨겨진 추가 비용은 일절 없습니다. 선택 항목으로 자궁유착방지제(5만원)가 있으며, 이는 수술 후 자궁 내 유착을 예방하여 향후 임신 가능성을 보호하는 데 도움이 됩니다. 임신중절수술금액 부담을 최소화하기 위해 불필요한 검사나 추가 시술을 권하지 않으며, 환자분이 납득하신 범위 내에서만 진행합니다.'
  },
  {
    q: 'Q. 임신 몇 주까지 낙태수술이 가능한가요?',
    a: '임신중절수술은 임신 주수가 적을수록 수술이 간단하고 회복이 빠르며, 낙태비용가격 부담도 적습니다. 일반적으로 임신 14주 이내가 가장 안전한 낙태시기이며, 모자보건법에 따라 14주 이내에는 본인의 결정으로 수술이 가능합니다. 임신 15주 이후에는 법적 허용 사유에 해당하는 경우에만 시행할 수 있으며, 수술 방법과 위험도가 달라집니다. 결정을 내리셨다면 가능한 한 빨리 내원하시는 것이 안전하며, 정확한 임신 주수는 초음파 검사를 통해서만 확인이 가능합니다.'
  },
  {
    q: 'Q. 낙태수술 시 통증이 심한가요?',
    a: '연세365산부인과의원에서는 수면마취(정맥마취) 하에 낙태수술을 진행하므로, 수술 중 통증을 거의 느끼지 않습니다. 수면마취는 전신마취와 달리 마취 깊이가 얕아 회복이 빠르며, 수술 후 30분~1시간 내에 의식이 완전히 회복됩니다. 수술 후에는 경미한 하복부 통증이 있을 수 있으나, 처방된 진통제로 충분히 관리 가능한 수준입니다. 풍부한 임상 경험을 가진 산부인과 전문의가 숙련된 기술로 수술 시간을 최소화하여 신체적 부담을 줄이고 있습니다.'
  },
  {
    q: 'Q. 낙태와 임신중절의 차이점은 무엇인가요?',
    a: '의학적으로 낙태와 임신중절은 동일한 의미를 가지며, 공식 의학 용어로는 "인공임신중절"이라고 합니다. 낙태뜻은 태아가 모체 밖에서 생존할 수 없는 시기에 인위적으로 임신을 종료하는 의료 행위를 말하며, 임신중절은 의료 현장에서 사용하는 중립적이고 정확한 용어입니다. 연세365산부인과의원에서 시행하는 임신중절수술은 모자보건법에 따라 합법적으로 시행되며, 풍부한 임상 경험을 가진 산부인과 전문의가 최신 의료 장비를 활용하여 안전하게 수술을 진행합니다. 낙태수술의 방법, 낙태비용, 회복 과정 등에 대해 궁금하신 점은 1:1 상담을 통해 자세히 안내받으실 수 있습니다.'
  },
  {
    q: 'Q. 임신중절수술 후 사후관리는 어떻게 이루어지나요?',
    a: '연세365산부인과의원은 임신중절수술 후 체계적인 1:1 사후 케어 시스템을 운영하고 있습니다. 수술 직후 전용 회복실에서 활력 징후를 모니터링하며, 영양수액 처치를 통해 체력 회복을 돕습니다. 퇴원 시에는 회복 기간 동안의 주의사항과 복용 약물에 대해 상세히 안내드리며, 수술 후 이상 증상 발생 시 전화 상담이 가능합니다. 또한 수술 1~2주 후 경과 확인을 위한 후속 진료를 권장드리고 있어, 낙태수술 후에도 자궁이 완전히 회복될 때까지 지속적으로 관리해드립니다. 모든 사후 관리 과정에서도 철저한 비밀 보장이 이루어집니다.'
  },
  {
    q: 'Q. 중절수술가격이 병원마다 다른 이유는 무엇인가요?',
    a: '중절수술가격은 병원의 의료진 경력, 시설 수준, 마취 방법, 사용 기구(일회용 여부), 사후 관리 범위에 따라 차이가 날 수 있습니다. 극단적으로 저렴한 낙태비용가격을 내세우는 곳은 재사용 기구 사용, 사후 관리 부재, 비전문의 시술 등의 위험이 있을 수 있으므로 주의가 필요합니다. 연세365산부인과의원은 일회용 멸균 기구만 사용하고, 풍부한 임상 경험을 가진 산부인과 전문의가 직접 수술을 시행하며, 수술 후 1:1 사후 케어를 포함한 합리적인 임신중절수술비용을 제공합니다. 안전과 합리적 가격, 두 가지를 모두 갖춘 신뢰할 수 있는 중절수술병원을 선택하시기 바랍니다.'
  },
  {
    q: 'Q. 약물중절(미프진)은 어떤 방법인가요?',
    a: '약물중절은 약물(미페프리스톤, 미소프로스톨 등)을 복용하여 수술 없이 임신을 종료하는 약물중절방법입니다. 약물중절후기에서 비교적 간편하다는 의견이 있으나, 현재 국내에서는 미프진 등 약물중절 약제가 공식 허가되지 않아 인증되지 않은 경로를 통한 약물중절은 불완전 유산, 대량 출혈, 감염 등 심각한 부작용 위험이 있습니다. 약물중절가격이 저렴해 보일 수 있으나, 부작용 발생 시 응급 수술이 필요할 수 있어 오히려 비용과 건강상의 부담이 커질 수 있습니다. 연세365산부인과의원은 중절수술병원으로서, 환자의 임신 주수와 건강 상태에 따라 흡입식소파술 또는 임신중절소파술 등 가장 안전한 임신초기중절수술 방법을 1:1 프라이빗 상담에서 안내드립니다.'
  },
  {
    q: 'Q. 임신중절수술은 합법인가요? 낙태합법화 이후 달라진 점은 무엇인가요?',
    a: '네, 임신중절수술은 합법입니다. 2021년 1월 1일부로 형법상 낙태죄 조항이 효력을 상실하면서 대한민국에서 낙태합법화가 이루어졌습니다. 낙태뜻은 태아가 모체 밖에서 생존할 수 없는 시기에 인위적으로 임신을 종료하는 의료 행위를 말하며, 의학적 공식 용어로는 인공임신중절이라고 합니다. 낙태합법 이후 임신 14주 이내의 임신중절수술은 임신부 본인의 자기결정권에 따라 합법적으로 시행할 수 있게 되었으며, 임신 15주~24주의 경우에는 모자보건법 제14조의 허용 사유에 해당하는 경우에만 가능합니다. 임신중절수술기간(적정 낙태시기)은 임신 주수가 적을수록 안전하므로, 임신초기낙태가 가장 권장됩니다. 낙태수술시기를 놓치지 않도록 임신이 의심되면 빠른 시일 내에 산부인과를 방문하시기 바랍니다. 연세365산부인과의원은 임신중절수술합법 시행 기관으로서 모든 의료법을 철저히 준수합니다.'
  },
  {
    q: 'Q. 당일 수술 및 퇴원이 가능한가요?',
    a: '네, 전문의가 수술 전 환자의 건강 상태를 평가하고, 수술 중 활력 징후를 실시간으로 모니터링하며 마취 깊이를 정밀하게 조절합니다. 당일 수술 및 퇴원이 가능한 원스톱 시스템을 운영하고 있어, 내원 당일 검사·1:1 프라이빗 상담·수술까지 한 번에 진행하실 수 있습니다. 수술 후에는 전용 회복실에서 영양수액 처치와 함께 충분한 휴식을 취하신 후 당일 귀가하실 수 있습니다. 수술 후 사후관리 프로그램을 통해 회복 경과를 꼼꼼히 추적 관리하며, 24시간 상담 시스템을 운영하여 퇴원 후에도 이상 증상 발생 시 즉시 연락하실 수 있습니다.'
  },
  {
    q: 'Q. 연세365산부인과의원은 어디에 있으며, 어떤 지역에서 많이 내원하시나요?',
    a: '연세365산부인과의원은 사당역 4번출구 바로 앞에 위치하여 대중교통 접근성이 매우 뛰어납니다. 지하철 2호선과 4호선이 교차하는 사당역 특성상 관악구 산부인과, 신림동 산부인과, 과천 산부인과를 찾으시는 분들은 물론, 강남역 산부인과·신논현역 산부인과·서초동 산부인과를 찾으시는 분들도 편리하게 내원하실 수 있어 강남 임신중절수술을 고려하시는 분들께서도 많이 찾아주고 계십니다. 연중무휴 산부인과로 운영되며, 주말과 공휴일에도 진료가 가능합니다. 임신중절가격과 낙태수술가격은 임신 주수에 따라 달라지며, 낙태비용금액에 대한 정확한 안내는 초음파 검사 후 1:1 상담에서 투명하게 제공됩니다. 임신중절수술후기가 궁금하시다면, 상담 시 수술 과정과 회복에 대해 경험 많은 전문의가 상세히 설명드립니다.'
  },
  {
    q: 'Q. 낙태수술 후 빈혈이 올 수 있나요?',
    a: '수술 과정에서 발생하는 불가피한 출혈이나 체력 소모로 인해 일시적인 어지럼증이나 빈혈 증상이 나타날 수 있습니다. 특히 평소 빈혈 수치가 낮았던 분들은 수술 후 철분 수치가 급격히 떨어질 수 있어 각별한 주의가 필요합니다. 연세365산부인과의원에서는 수술 전후 혈액 검사를 통해 환자분의 상태를 면밀히 파악하며, 필요한 경우 고농축 철분 주사나 맞춤형 영양 수액을 처방하여 신속한 회복을 돕고 있습니다. 수술 후 약 2주간은 균형 잡힌 식단과 함께 철분 섭취에 신경 써주시는 것이 일상 복귀에 큰 도움이 됩니다.'
  },
];
...
const tabLabels = ['비용안내', '확인방법', '수술안내', 'FAQ'];
      ...
      <div className="container mx-auto px-5 md:px-12">
        ...
        <div className="text-center mb-8 md:mb-20">
          ...
          <p className="text-gray-600 text-[13px] md:text-lg leading-[1.8] md:leading-relaxed max-w-3xl mx-auto px-1 md:px-0">
            연세365산부인과의원은 여성의 건강과 안전을 최우선으로 생각합니다.
        ...
        <div className="md:hidden">
              ...
              {mobileTab === 0 && (
                ...
                <div className="mt-4 p-4 bg-white/80 rounded-xl border border-primary/5">
                  <p className="text-[11px] text-gray-600 leading-[1.8]">
                    <strong className="text-gray-700">임신중절수술 금액</strong>은 8주 미만 45만원, 8주 60만원, 9주 70만원, 10주 80만원입니다. <strong className="text-gray-700">낙태비용</strong>은 임신 주수에 따라 달라지며, 주수가 적을수록 <strong className="text-gray-700">임신중절수술비용</strong> 부담이 낮아집니다. 연세365산부인과의원은 초음파 검사 후 정확한 주수를 확인하여 추가 비용 없이 투명한 <strong className="text-gray-700">중절수술가격</strong>을 안내합니다. <strong className="text-gray-700">낙태비용얼마</strong>인지 궁금하시다면 1:1 상담에서 <strong className="text-gray-700">임신중절수술가격</strong>과 <strong className="text-gray-700">임신중절수술금액</strong>을 명확히 확인하실 수 있습니다. 풍부한 임상 경험을 가진 산부인과 전문의의 숙련된 수술과 합리적인 <strong className="text-gray-700">낙태비용</strong>으로 경제적·신체적 부담을 최소화합니다.
                  </p>
                </div>
                </>
              )}
              ...
              {mobileTab === 1 && (
                <>
                  ...
                  <div className="mb-10">
                    ...
                    <p className="text-center text-gray-500 mb-6 text-xs leading-relaxed">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {symptoms.map((s) => (
                        <div key={s.id} className="flex flex-col items-center text-center">
                          ...
                          <p className="text-[11px] text-gray-600 leading-[1.7]">{s.description}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                      ...
                      {diagnosisMethods.map((m) => (
                        <div key={m.id} className="bg-white rounded-xl overflow-hidden shadow border border-primary/10 flex">
                          ...
                          <div className="p-3 flex-1 min-w-0">
                            ...
                            <p className="text-[11px] text-gray-600 leading-[1.7]">{m.description}</p>
                          </div>
                        </div>
                      ))}
                    </div>
              ...
              {mobileTab === 2 && (
                <>
                  <div className="mb-10">
                    ...
                    <p className="text-center text-gray-500 mb-6 text-[11px] leading-relaxed">
                  ...
                  <div className="mt-6 p-4 bg-gradient-to-r from-primary/5 to-purple-50 rounded-xl border border-primary/10">
                    ...
                    <p className="text-[11px] text-gray-600 leading-[1.8]">
                      연세365산부인과의원은 <strong className="text-gray-700">낙태수술</strong> 후 전용 회복실에서 1:1 케어를 제공하며, 퇴원 후에도 전화 상담과 후속 진료를 통해 완전한 회복을 돕습니다. 접수부터 퇴원까지 모든 과정에서 <strong className="text-gray-700">철저한 비밀 보장</strong>이 이루어지며, 풍부한 임상 경험을 가진 산부인과 전문의가 <strong className="text-gray-700">임신중절수술</strong>을 직접 시행합니다. <strong className="text-gray-700">마취과 전문의 협진</strong>과 <strong className="text-gray-700">수술 후 사후관리 프로그램</strong>으로 안전하고 체계적인 진료를 제공합니다.
                    </p>
                  </div>
                </>
              )}
          ...
          <div className="mt-8 bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-5 border border-primary/10">
            ...
            <p className="text-[11px] text-gray-600 leading-[1.8] mb-3">
              <strong className="text-gray-700">인공임신중절</strong>(<strong className="text-gray-700">낙태</strong>)이란 태아가 모체 밖에서 생존할 수 없는 시기에 인위적으로 임신을 종료하는 의료 행위를 말합니다. 2021년 1월 1일부로 형법상 낙태죄 조항이 효력을 상실하면서 <strong className="text-gray-700">낙태합법화</strong>가 이루어졌으며, 임신 14주 이내의 <strong className="text-gray-700">임신중절수술</strong>은 본인의 자기결정권에 의해 합법적으로 시행할 수 있습니다.
            </p>
            <p className="text-[11px] text-gray-600 leading-[1.8] mb-3">
              연세365산부인과의원은 의료법을 철저히 준수하며, 풍부한 임상 경험을 가진 산부인과 전문의가 <strong className="text-gray-700">마취과 전문의 협진</strong> 하에 안전한 <strong className="text-gray-700">임신중절수술</strong>을 직접 시행합니다. <strong className="text-gray-700">낙태수술시기</strong>는 임신 주수가 적을수록 안전하며, <strong className="text-gray-700">임신초기낙태</strong>가 가장 권장됩니다. <strong className="text-gray-700">임신초기중절</strong> 시에는 <strong className="text-gray-700">흡입식소파술</strong>을, 이후에는 <strong className="text-gray-700">임신중절소파술</strong>을 시행합니다.
            </p>
            <div className="bg-white/80 rounded-lg p-3 mb-3">
              <h4 className="font-bold text-primary text-[11px] mb-2">[모자보건법 제14조 - 인공임신중절 허용 사유]</h4>
              <ul className="space-y-1.5 text-[10px] text-gray-600 leading-[1.7]">
                <li><span className="text-primary font-bold">1.</span> 본인 또는 배우자가 우생학적·유전학적 정신장애나 신체질환이 있는 경우 — 유전성 질환으로 태아에게 심각한 장애가 발생할 가능성이 높은 경우</li>
                <li><span className="text-primary font-bold">2.</span> 본인 또는 배우자가 전염성 질환이 있는 경우 — 풍진, HIV 등 태아에게 수직 감염될 수 있는 질환</li>
                <li><span className="text-primary font-bold">3.</span> 강간 또는 준강간에 의해 임신된 경우 — 성폭력 피해로 인한 임신은 피해자의 동의만으로 진행 가능</li>
                <li><span className="text-primary font-bold">4.</span> 법률상 혼인할 수 없는 혈족 또는 인척 간에 임신인 경우</li>
                <li><span className="text-primary font-bold">5.</span> 임신의 지속이 보건의학적 이유로 모체의 건강을 심각하게 해치고 있거나 해칠 우려가 있는 경우</li>
              </ul>
            </div>
            <p className="text-[10px] text-gray-500 leading-[1.7]">
              ※ <strong className="text-gray-600">임신중절수술</strong>은 <strong className="text-gray-600">임신중절수술합법</strong> 시행 기관에서 안전하게 진행해야 합니다. 연세365산부인과의원은 <strong className="text-gray-600">24시간 상담 시스템</strong>과 <strong className="text-gray-600">1:1 프라이빗 상담</strong>을 통해 환자분의 상황에 맞는 최적의 방법을 안내드립니다.
            </p>
          </div>
          ...
          {/* 의료법 제56조 준수 및 부작용 안내 — 모바일 */}
          <div className="mt-6 bg-gray-50 rounded-xl p-4 border border-gray-200">
            <p className="text-[10px] text-gray-500 leading-[1.7] mb-2">
              <strong className="text-gray-600">[의료법 제56조 제1항 준수]</strong> 본 페이지의 내용은 의료법 제56조(의료광고의 금지 등) 제1항에 따라 환자에게 의료 정보를 제공하기 위한 목적으로 작성되었으며, 특정 의료 행위를 보장하거나 효과를 과대 광고하는 것이 아닙니다.
            </p>
            <p className="text-[10px] text-gray-500 leading-[1.7]">
              <strong className="text-gray-600">[부작용 및 주의사항]</strong> 임신중절수술은 개인의 건강 상태에 따라 출혈, 감염, 자궁 천공, 자궁경부 손상, 마취 관련 부작용 등이 발생할 수 있습니다. 모든 수술에는 부작용의 가능성이 있으므로, 반드시 전문의와 충분한 상담 후 신중하게 결정하시기 바랍니다. 수술 후 과다 출혈, 고열, 심한 복통 등 이상 증상이 나타나면 즉시 의료기관에 내원하셔야 합니다.
            </p>
          </div>
        </div>
        ...
        {/* =============================================================== */}
        {/* ===== DESKTOP — 기존 모든 섹션 그대로 유지 (탭 순서 변경) ===== */}
        {/* =============================================================== */}
        <div className="hidden md:block">
          ...
          <div id="ab-cost" className="max-w-xl mx-auto mb-16 scroll-mt-20">
            ...
            <div className="mt-8 bg-white rounded-xl p-6 md:p-8 border border-primary/10 shadow-sm">
              ...
              <div className="space-y-3 text-sm text-gray-700 leading-relaxed">
                ...
                <p>
                  연세365산부인과의원은 <strong className="text-gray-800">합리적인 임신중절수술비용</strong>을 통해 환자분의 경제적 부담을 최소화하는 데 최선을 다하고 있습니다. 불필요한 추가 검사나 시술을 권하지 않으며, 상담 시 안내받은 <strong>낙태비용</strong> 외에 숨겨진 비용은 일절 없습니다. 현금과 카드 가격이 동일하며, 풍부한 임상 경험을 가진 산부인과 전문의가 직접 수술을 시행합니다.
                </p>
                <p>
                  <strong className="text-gray-800">임신중절수술가격</strong>과 <strong className="text-gray-800">임신중절수술금액</strong>은 수술 방법(<strong>흡입식소파술</strong>, <strong>임신중절소파술</strong> 등)과 마취 방법에 따라서도 달라질 수 있습니다. <strong>낙태수술가격</strong>, <strong>낙태비용금액</strong>, <strong>낙태금액</strong>이 궁금하시다면 1:1 상담에서 <strong>임신중절비용</strong>과 <strong>임신중절금액</strong>, <strong>임신중절가격</strong>, <strong>중절수술금액</strong>을 투명하게 안내받으실 수 있습니다. 많은 환자분들이 <strong>임신중절수술후기</strong>에서 &lsquo;투명한 가격 안내에 안심할 수 있었다&rsquo;고 전해주고 계십니다.
                </p>
                <p className="text-primary font-semibold text-xs">
                  ※ 정확한 <strong>낙태비용가격</strong>은 초음파 검사를 통해 임신 주수를 확인한 후 1:1 상담에서 안내드립니다. <strong>낙태비용얼마</strong>인지 궁금하시다면 카카오톡 또는 전화로 언제든 문의 가능합니다.
                </p>
              </div>
            </div>
          </div>

          {/* ========== 임신중절수술 법적 정보 (확장 — 2배 이상) ========== */}
          <div id="ab-diagnosis" className="max-w-5xl mx-auto mb-16 scroll-mt-20">
            <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8 md:p-12 border border-primary/10 text-center">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 max-w-3xl mx-auto">
                <strong>인공임신중절</strong>(<strong>낙태</strong>)이란 태아가 모체 밖에서 생존할 수 없는 시기에 인위적으로 임신을 종료하는 의료 행위를 말합니다.
                <br />
                2021년 1월 1일부로 형법상 낙태죄 조항이 효력을 상실하면서, 대한민국에서도 <strong>낙태합법화</strong>가 이루어졌습니다.
                <br />
                이에 따라 임신 14주 이내의 <strong>임신중절수술</strong>은 임신부 본인의 자기결정권에 의해 <strong>임신중절수술합법</strong>적으로 시행할 수 있게 되었으며,
                <br />
                임신 15주~24주의 경우에는 모자보건법 제14조에 규정된 허용 사유에 해당될 때 진행이 가능합니다.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4 max-w-3xl mx-auto">
                연세365산부인과의원은 의료법과 모자보건법을 철저히 준수하며, 풍부한 임상 경험을 가진 산부인과 전문의가
                <br />
                투명한 <strong>낙태비용가격</strong> 안내와 함께 안전하고 세심한 <strong>임신중절</strong> 진료를 시행하고 있습니다.
              </p>

              <p className="text-gray-700 leading-relaxed mb-4 max-w-3xl mx-auto">
                <strong>낙태수술시기</strong>는 임신 주수가 적을수록 수술이 안전하고 회복이 빨라, <strong>임신초기낙태</strong>가 가장 권장됩니다.
                <br />
                <strong>임신초기중절</strong>(7주 이내)에는 <strong>흡입식소파술</strong>을, 그 이후에는 <strong>임신중절소파술</strong>(경관확장 소파술)을 주로 시행하며,
                <br />
                <strong>수술 후 사후관리 프로그램</strong>을 통해 완전한 회복까지 <strong>1:1 프라이빗 상담</strong>과 맞춤 관리를 제공합니다.
              </p>

              <p className="text-gray-600 leading-relaxed mb-8 max-w-3xl mx-auto text-sm">
                사당역에 위치한 연세365산부인과의원은 <strong>관악구 산부인과</strong>, <strong>신림동 산부인과</strong>, <strong>과천 산부인과</strong>를 찾으시는 분들은 물론,
                <br />
                <strong>강남역 산부인과</strong>, <strong>신논현역 산부인과</strong>, <strong>서초동 산부인과</strong> 등 서울 전역에서 내원하시는 환자분들에게
                <br />
                안전하고 신뢰할 수 있는 <strong>강남 임신중절수술</strong>을 제공하고 있습니다.
                <br />
                <strong>연중무휴 산부인과</strong>로 주말·공휴일에도 진료 가능하며, <strong>24시간 상담 시스템</strong>을 운영합니다.
              </p>
              
              <div className="bg-white/80 rounded-xl p-6 backdrop-blur-sm max-w-3xl mx-auto text-left">
                <h4 className="font-bold text-primary mb-4 text-lg text-center">[모자보건법 제14조 - 인공임신중절 허용 사유]</h4>
                <ul className="space-y-3 text-sm text-gray-700 inline-block">
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1 font-bold">1.</span>
                    <span>본인 또는 배우자가 대통령령으로 정하는 우생학적 또는 유전학적 정신장애나 신체질환이 있는 경우 — 유전성 질환으로 태아에게 심각한 장애가 발생할 가능성이 높은 경우에 해당합니다.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1 font-bold">2.</span>
                    <span>본인 또는 배우자가 대통령령으로 정하는 전염성 질환이 있는 경우 — 풍진, HIV 등 태아에게 수직 감염될 수 있는 전염성 질환이 이에 해당합니다.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1 font-bold">3.</span>
                    <span>강간 또는 준강간(형법 제297조, 제299조)에 의하여 임신된 경우 — 성폭력 피해로 인한 임신의 경우 피해자의 동의만으로 진행 가능합니다.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1 font-bold">4.</span>
                    <span>법률상 혼인할 수 없는 혈족 또는 인척 간에 임신인 경우 — 민법에서 금지하는 근친 간의 임신이 이에 해당합니다.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1 font-bold">5.</span>
                    <span>임신의 지속이 보건의학적 이유로 모체의 건강을 심각하게 해치고 있거나 해칠 우려가 있는 경우 — 산모의 생명이나 건강에 중대한 위험이 예상되는 경우 의사의 판단에 따라 시행됩니다.</span>
                  </li>
                </ul>
                <p className="mt-4 text-xs text-gray-500 text-center leading-relaxed">
                  ※ <strong>임신중절수술</strong>은 합법적으로 시행되는 의료 행위이며, 모든 시술은 환자의 안전과 권리를 최우선으로 보호합니다.
                  <br />
                  연세365산부인과의원은 <strong>당일 수술 및 퇴원</strong>이 가능하며, <strong>철저한 비밀 보장</strong> 하에 모든 진료가 진행됩니다.
                </p>
              </div>
            </div>
          </div>
          ...
          <div id="ab-procedure" className="max-w-5xl mx-auto mb-16 scroll-mt-20">
            ...
            <p className="text-center text-gray-600 mb-6 text-sm">연세365산부인과의원은 체계적인 <strong>낙태수술</strong> 프로세스로 환자 안전을 최우선으로 지킵니다</p>
          ...
          <div className="max-w-6xl mx-auto mb-16">
            ...
            <p className="text-center text-gray-500 mb-12 text-sm max-w-3xl mx-auto leading-relaxed">
              연세365산부인과의원은 <strong>임신중절수술</strong> 후 체계적인 <strong>1:1 사후 케어 시스템</strong>을 운영합니다.<br />
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-200">
              <div className="space-y-3 text-sm text-gray-500 leading-relaxed">
                ...
                <p>
                  <strong className="text-gray-600">[부작용 및 주의사항 안내]</strong> 임신중절수술은 개인의 건강 상태에 따라 출혈, 감염, 자궁 천공, 자궁경부 손상, 마취 관련 부작용 등이 발생할 수 있습니다. 모든 수술에는 부작용의 가능성이 있으므로, 반드시 전문의와 충분한 상담 후 신중하게 결정하시기 바랍니다. 수술 후 과다 출혈, 고열, 심한 복통 등 이상 증상이 나타나면 즉시 의료기관에 내원하셔야 합니다.
                </p>
              </div>
            </div>
          </div>
